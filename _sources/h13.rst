...
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------+
| R is one of the most common software packaged used for data science. Python is a second software package often utilized in data science. The use of R is widespread because   | |https://www.r-project.org/Rlogo.png|   |
|                                                                                                                                                                               |                                         |
...
stats with #. That is, any line that starts with # will be ignored upon
submitting the code to be executed.
...
The > log(5) command used above is a example of a built-in *function* in
R. When using functions, it may be useful to hit the TAB key. For
...
index, the loop runs from i=1 to i=10. Once again the [ ] syntax is used
to place the output into its respective element of the output vector.
...
|                                | | i=2    | 4                  |   |
| **                             | +--------+--------------------+   |
| Better method in R**           | | i=3    | 6                  |   |
|                                | +--------+--------------------+   |
| **output <- seq(1,10)**        | | i=4    | 8                  |   |
|                                | +--------+--------------------+   |
| **output <- output \* 2**      | | i=5    | 10                 |   |
|                                | +--------+--------------------+   |
| **or **                        | | i=6    | 12                 |   |
|                                | +--------+--------------------+   |
| **output <- 2 \* seq(1,10)**   | | i=7    | 14                 |   |
|                                | +--------+--------------------+   |
|                                | | i=8    | 16                 |   |
|                                | +--------+--------------------+   |
|                                | | i=9    | 18                 |   |
...
e. Rewrite Line 17 to read: newmydata[,i] = Col2[(Col1 %% 4) == (i-1)]
   Is the mydata data.frame needed or is this loop able to work directly
   with the individual vectors? Briefly discuss.

.. |https://www.r-project.org/Rlogo.png| image:: ../img/h13/media/image1.png
   :width: 1.34409in
   :height: 1.04167in
.. |image1| image:: ../img/h13/media/image2.png
   :width: 3.86087in
   :height: 1.32874in
.. |image2| image:: ../img/h13/media/image3.png
   :width: 4.07292in
   :height: 0.84548in
.. |image3| image:: ../img/h13/media/image4.png
   :width: 4.30208in
   :height: 1.05024in
.. |image4| image:: ../img/h13/media/image5.png
   :width: 4.51337in
   :height: 1.28898in
.. |image5| image:: ../img/h13/media/image6.png
   :width: 1.84722in
   :height: 1.96729in
.. |image6| image:: ../img/h13/media/image7.png
   :width: 0.86842in
   :height: 1.83333in
.. |image7| image:: ../img/h13/media/image8.png
   :width: 2.31250in
   :height: 0.85919in
.. |image8| image:: ../img/h13/media/image9.png
   :width: 5.60185in
   :height: 2.32992in
